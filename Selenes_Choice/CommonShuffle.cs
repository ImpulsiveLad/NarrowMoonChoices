    ...
    public static class CommonShuffle
    {
        public static void ShuffleMoons(int Seed)
        {
            ...
            if (UpdateConfig.freeMoonCount != 0)
            {
                ...
                instance.mls.LogInfo("Safety Moon: " + randomFreeLevel.SelectableLevel.PlanetName);

                UpdateConfig.freeMoonCount -= 1;
            }
            else if (UpdateConfig.paidMoonCount != 0)
            {
                ...
                instance.mls.LogInfo("Safety Moon: " + paidsafetylevel.SelectableLevel.PlanetName);
            ...
            else
            {
                ...
                instance.mls.LogInfo("Safety Moon: " + Anysafetylevel.SelectableLevel.PlanetName);

                UpdateConfig.randomMoonCount -= 1;
            }
